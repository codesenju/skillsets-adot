...
function App() {
  ...
  useEffect(() => {
    axios
      .get("https://skillsets.lmasu.co.za/get_all_engineers")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedEngineer) {
      axios
        .get(`https://skillsets.lmasu.co.za/get_skills?name=${selectedEngineer}`)
        .then((response) => {
          console.log(response.data);
  ...
  const handleDelete = () => {
    if (selectedEngineer) {
      axios
        .delete(`https://skillsets.lmasu.co.za/delete_engineer/${selectedEngineer}`)
        .then((response) => {
          console.log(response.data);
  ...
  const handleUpdate = () => {
    if (selectedEngineer && updatedSkills) {
      axios
        .put(`https://skillsets.lmasu.co.za/update_engineer_skillset/${selectedEngineer}`, { skills: updatedSkills })
        .then((response) => {
          console.log(response.data);
